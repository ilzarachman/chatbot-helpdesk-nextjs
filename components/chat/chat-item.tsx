...
export function BotChat({ prompt, text, generation }: { prompt: string; text: string; generation: boolean }) {
                        ...
                        {!generation ?
                            <Dialog open={isFeedbackOpen} onOpenChange={setIsFeedbackOpen}>
                                <DialogTrigger asChild>
                                    <Button variant="outline" className="w-[150px]"><MessageSquareDiff className="w-5 h-5 mr-2" /> Feedback</Button>
                                </DialogTrigger>
                                <DialogContent>
                                    <DialogHeader>
                                    ...
                                    <FeedbackForm bot_answer={text} prompt={prompt} onClose={closeFeedback} />
